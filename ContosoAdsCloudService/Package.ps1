...
$classicEv2DeploymentVariables = @{
    SubscriptionId = "da28f5e5-aa45-46fe-90c8-053ca49ab4b5"
    ResourceGroupName = "minsha-az-prototype-externalsupport"
    DeploymentLabel = ( Get-Date -Format "yyyy-MM-dd HH:mm")
    CloudServiceName = "minsha-az-prototype-externalsupport"
}
$externalSupportOutDir = "$PSScriptRoot\bin\externalSupport\"
